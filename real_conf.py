# -*- coding: utf-8 -*-
#
# Erebot documentation build configuration file, created by
# sphinx-quickstart on Sun Dec 11 20:09:06 2011.
#
...
release = os.environ.get('SPHINX_RELEASE', version)

# The language for content autogenerated by Sphinx. Refer to documentation
# for a list of supported languages.
if 'SPHINX_LANGUAGE' in os.environ:
    language = os.environ['SPHINX_LANGUAGE']
else:
    language = "en"

copyright = u'%d, The Erebot team' % datetime.now().year
...
#html_use_opensearch = 'http://erebot.github.com/Erebot/'
